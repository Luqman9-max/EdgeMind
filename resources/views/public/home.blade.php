...
<section id="hero" class="relative w-full min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-em-black">
    ...
    <div class="container-edge relative z-10 w-full text-center flex flex-col items-center">
        <div class="hero-tag opacity-0 mb-6">
            <span class="inline-block border-x-4 border-em-accent bg-em-black/80 backdrop-blur-sm text-em-accent font-mono text-xs px-6 py-2 uppercase tracking-[0.3em] shadow-[0_0_20px_rgba(255,61,0,0.2)]">
                <span class="typewriter inline-block" style="animation-duration: 2s; animation-fill-mode: both;">SYSTEM OVERRIDE INITIATED</span>
            </span>
        </div>
        ...
        <div class="hero-cta opacity-0 flex flex-col items-center justify-center relative w-full max-w-md mx-auto">
            <div class="absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-em-accent to-transparent z-0 line-draw w-0 mx-auto"></div>
            <a href="{{ route('evolve') }}" class="btn btn-primary btn-lg relative z-10 shadow-[0_0_40px_rgba(255,61,0,0.3)] heartbeat hover:shadow-[0_0_60px_rgba(255,61,0,0.5)] transition-all duration-300 transform hover:scale-110 bg-em-black border-2 border-em-accent text-em-white hover:bg-em-accent">
                ENTER THE SYSTEM
            </a>
        </div>
    </div>
    ...
    {{-- Scroll Indicator --}}
    <div class="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 z-10 opacity-60 hover:opacity-100 transition-opacity cursor-pointer scroll-indicator">
        <span class="font-mono text-[10px] text-em-accent uppercase tracking-[0.3em]">Initiate Descent</span>
        <span class="material-symbols-outlined text-em-accent animate-bounce">south</span>
    </div>
</section>
    ...
    <div class="container-edge relative z-10">
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            <div class="truth-text opacity-0">
                ...
                <!-- Sliding Blockquote -->
                <blockquote class="border-draw border-l-8 border-em-accent bg-em-gunmetal p-8 mt-8 relative overflow-hidden group">
                    <div class="absolute top-0 left-0 w-0 h-full bg-em-accent-glow transition-all duration-700 group-hover:w-full z-0"></div>
                    <p class="relative z-10 text-em-white font-medium text-2xl italic m-0">Motivation is a feeling. It evaporates. What you need is structure, pressure, and absolute clarity.</p>
                </blockquote>
            </div>
            
            <div class="truth-vis opacity-0 flex flex-col justify-center items-end relative">
...
<section id="cost" class="py-32 bg-em-charcoal relative border-y border-em-steel overflow-hidden cost-section">
    ...
    <div class="container-edge relative z-10 pt-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div class="card-edge bg-em-black/80 backdrop-blur-md p-10 cost-card border-t-4 border-t-em-steel hover:border-t-em-accent transition-colors group relative overflow-hidden">
            ...
            <div class="card-edge bg-em-black/80 backdrop-blur-md p-10 cost-card border-t-4 border-t-em-steel hover:border-t-em-accent transition-colors group relative overflow-hidden" style="transition-delay: 100ms;">
                <div class="font-mono text-em-slate text-xs mb-6 uppercase tracking-widest flex items-center justify-between">
            ...
            <div class="card-edge bg-em-gunmetal p-10 cost-card border-t-4 border-t-em-accent shadow-[0_0_40px_rgba(255,61,0,0.1)] group relative overflow-hidden" style="transition-delay: 200ms;" id="compound-card">
...
<section id="diagnostic" class="py-32 bg-em-black relative overflow-hidden">
    <div class="container-edge">
        <div class="max-w-4xl mx-auto bg-em-gunmetal border border-em-steel p-1 md:p-2 slam-down shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative group hover:border-em-slate transition-colors duration-500 diagnostic-container">
            ...
            <div class="relative z-10 bg-em-charcoal h-full w-full p-8 md:p-12 border border-em-steel/50" x-data="{ step: 0, answers: [], result: null, 
                bootSequence: [
                ...
                {{-- Boot Sequence --}}
                <div x-show="step === 0" class="py-20 flex flex-col items-start justify-center min-h-[300px]">
                ...
                <div x-show="step === 1" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-cloak class="min-h-[300px] flex flex-col justify-center items-center relative z-10 py-12">
                    ...
                    <div class="space-y-4 max-w-2xl w-full" style="margin-top: 2rem;">
                        ...
                        <button @click="flash(); answers.push('intent'); setTimeout(() => step = 2, 300);" class="w-full text-left p-6 border border-em-steel bg-em-black hover:border-em-ice transition-all group relative overflow-hidden">
                ...
                <div x-show="step === 2" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-cloak class="min-h-[300px] flex flex-col justify-center items-center relative z-10 py-12">
                    ...
                    <div class="space-y-4 max-w-2xl w-full" style="margin-top: 2rem;">
                        ...
                        <button @click="flash(); answers.push('confront'); setTimeout(() => step = 3, 300);" class="w-full text-left p-6 border border-em-steel bg-em-black hover:border-em-ice transition-all group relative overflow-hidden">
                            <div class="absolute inset-0 bg-em-ice/10 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300"></div>
                            <span class="relative z-10 font-mono text-em-slate mr-4 group-hover:text-em-ice transition-colors">>_</span> 
                ...
                <div x-show="step === 3" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-cloak class="min-h-[300px] flex flex-col justify-center items-center relative z-10 py-12">
                    ...
                    <div class="space-y-4 max-w-2xl w-full" style="margin-top: 2rem;">
                        ...
                        <button @click="flash(); answers.push('executing'); result = 'LACK OF SCALE'; setTimeout(() => step = 4, 300);" class="w-full text-left p-6 border border-em-steel bg-em-black hover:border-em-ice transition-all group relative overflow-hidden">
                            <div class="absolute inset-0 bg-em-ice/10 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300"></div>
                            <span class="relative z-10 font-mono text-em-slate mr-4 group-hover:text-em-ice transition-colors">>_</span> 
                ...
                {{-- Result --}}
                <div x-show="step === 4" x-transition:enter="transition ease-out duration-700 transform" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-cloak class="text-center py-12 flex flex-col items-center min-h-[300px] relative z-10">
                    ...
                    <div class="text-6xl md:text-8xl font-black text-em-accent mb-10 glitch-intense leading-none uppercase" x-text="result" :data-text="result"></div>
...
<section id="arsenal" class="py-32 bg-em-charcoal border-y border-em-steel overflow-hidden relative perspective-1000">
    <div class="container-edge relative">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end mb-20 relative z-10 opacity-0 transform translate-y-10 arsenal-header">
            <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10 arsenal-grid">
            @forelse($featuredBooks as $index => $book)
            <div class="tilt-card opacity-0 transform translate-y-10" style="transition-delay: {{ $index * 100 }}ms">
                <a href="{{ route('book.show', $book->slug) }}" class="card-edge bg-em-gunmetal group block relative shadow-[0_10px_30px_rgba(0,0,0,0.5)] hover:shadow-[0_20px_50px_rgba(255,61,0,0.2)] transition-all duration-500 tilt-card-inner">
...
<section class="py-32 bg-em-charcoal border-y border-em-steel overflow-hidden relative">
    ...
    <div class="container-edge relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="slam-left bg-em-black border border-em-steel p-8 lg:p-12 relative overflow-hidden group hover:border-em-accent transition-colors duration-500 shadow-[0_0_50px_rgba(0,0,0,0.8)]">
...
<section class="py-32 bg-em-black overflow-hidden relative">
    ...
    <div class="container-edge relative z-10">
        <div class="text-center mb-20 flex flex-col items-center opacity-0 transform translate-y-10 reports-header">
            <h2 class="text-5xl md:text-7xl font-black text-em-white mb-6 uppercase tracking-tight">Signal <span class="text-transparent bg-clip-text bg-gradient-to-r from-em-silver to-em-slate">Intercept.</span></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto reports-grid">
            {{-- Report 1 --}}
            <div class="dossier-card border border-em-steel p-10 hover:border-em-accent hover:-translate-y-2 transition-all duration-300 relative group opacity-0 transform translate-y-10 overflow-hidden bg-em-black">
            ...
            {{-- Report 2 --}}
            <div class="dossier-card border-2 border-em-ice p-10 relative transform md:-translate-y-6 hover:-translate-y-8 transition-all duration-300 group opacity-0 translate-y-10 overflow-hidden bg-em-gunmetal shadow-[0_0_30px_rgba(0,212,255,0.1)]">
                <div class="noise-burst group-hover:active"></div>
...
<section class="py-32 bg-em-charcoal border-t border-em-steel relative overflow-hidden" id="pressure-test">
    <div class="container-edge relative z-10">
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            }" class="slam-left border-2 border-em-steel p-10 bg-em-black relative transition-colors duration-500" :class="{'border-em-accent shadow-[0_0_50px_rgba(255,61,0,0.2)]': checkedCount === required}" id="auth-box">
            ...
            <div class="mt-16 lg:mt-0 flex flex-col justify-center warning-list">
                <div class="flex items-center gap-4 mb-8 text-em-accent opacity-0 transform -translate-x-10 warning-item">
                ...
                <ul class="space-y-10 border-l-2 border-em-steel pl-8">
                    <li class="relative opacity-0 transform -translate-x-10 warning-item">
                ...
                <div class="mt-12 font-mono text-em-accent text-sm uppercase tracking-widest opacity-0 warning-item flex items-center gap-2">
...
<section class="py-40 bg-em-black relative overflow-hidden text-center border-t border-em-accent/30" id="final-cta">
    ...
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-[600px] bg-radial-gradient from-em-accent/20 to-transparent blur-[100px] z-0 animate-pulse" style="background: radial-gradient(circle, rgba(255,61,0,0.15) 0%, rgba(0,0,0,0) 70%);"></div>
    ...
    <div class="container-edge relative z-10 flex flex-col items-center">
        ...
        <p class="text-xl md:text-3xl font-medium font-body text-em-silver mb-16 max-w-3xl mx-auto leading-relaxed border-l-4 border-em-accent pl-6 text-left opacity-0 cta-element bg-em-charcoal/50 p-6 backdrop-blur-sm">
